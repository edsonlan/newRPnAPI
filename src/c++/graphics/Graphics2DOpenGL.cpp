...
double * Graphics2DOpenGL::getWCCoords(int xDevice, int yDevice) {
    ...
    gluUnProject((double) xDevice, (double) yDevice, 0,
            model,
            proj,
            view,
            &objX,
    ...
    WCoords[0] = objX;
    WCoords[1] = 1-objY; // Y upside down
    WCoords[2] = objZ;
...
Graphics2DOpenGL::~Graphics2DOpenGL() {
    ...
    glXDestroyContext(dsi_x11->display,glc);
