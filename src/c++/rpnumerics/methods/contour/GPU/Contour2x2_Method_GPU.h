#ifndef _CONTOUR2X2_METHOD_GPU_
#define _CONTOUR2X2_METHOD_GPU_
...
class Contour2x2_Method_GPU {
    ...
    public:
        ...
        static void cpu_curve2x2(ThreeImplicitFunctions *timpf,
